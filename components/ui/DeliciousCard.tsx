  ...
  return (
    ...
    <Link href={'/recipes/1'} className="card border rounded-lg">
      <div className="img max-h-[300px] rounded-t-lg overflow-hidden group">
        <Image src="/header1.jpg" alt="food" width={0} height={0} sizes="300px" className=" group-hover:scale-110 duration-300 w-full h-full object-cover" />
      </div>
      <div className="content px-3 py-6 space-y-3">
        ...
        <h4 className="text-3xl font-bold">delicious fancy glazed bluebery donuts</h4>
        <div className="author flex items-center gap-3">
          <Image src="/header1.jpg" alt="author" width={0} height={0} className="rounded-full w-10 h-10 object-cover" />
